...
CSOT is a three-prompt system that governs how a human and Claude collaborate across sessions on a software project. It replaces ad-hoc context-setting with a repeatable workflow: one document that defines the project, one that opens each session, and one that closes it.
...
6. Pin the completed charter to your Claude Project
7. Use `prompts/session-brief.md` to open every subsequent session
8. Use `prompts/reflection.md` to close every session and update the charter
